...
def add_questions():
    questions = [
        ...
        ('Какая высота у эвереста?','8848км','8848м','8848 чего-то','хлеб'),
        ('Что в Японии делают из фекалей слона?','пиво','хлеб','вино','удобрение'),

        ('Какой национальный цветок Японии?','Сакура','Ромашка','Одуванчик','Роза'),
        ('Сколько дней нужно, чтобы Земля совершила оборот вокруг Солнца?','365','368','345','354'),
        ('Сколько полос на флаге США?','13','12','14','15'),
        ('Какая валюта Дании?','Крона','Тенге','Доллары','Динар'),
        ('На каком языке больше всего слов?','Английский','Казахский','Китайский', 'Французский'),

        ('Сколько спутников у Марса?','2','13','30','1'),
        ('Самый большой вулкан Солнечной системы называется «Гора Олимп». Где он находится?','Марс','Нептун','Венера','Юпитер'),
        ('Из чего в основном состоит Солнце?','Газ','Жидкая лава','Расплавленный метал','Плазма'),
        ('Какая планета ближе всех расположена к Солнцу?','Меркурий','Уран','Венера','Марс'),
        ('Из чего в основном состоят кометы?','Лед и Пыль','Газ','Ядовитая жидкость', 'Камень')
    ]
    open()
